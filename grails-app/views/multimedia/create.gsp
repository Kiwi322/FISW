...
<html>
	...
	<body>
		<div class="page container">
			...
			<g:form url="[resource:multimediaInstance, action:'upload']"  enctype="multipart/form-data" class="form-horizontal">
				<div class="container">
					<div class="alert alert-block alert-info">
	                    <p>
	                       Sube una nueva foto. Los campos marcados con asterisco son obligatorios.	
	                    </p>
	                </div>
