 ...
 <div class="row">
	<div class="span7">
		<fieldset>
			...
			<div class="control-group ">
			    <label class="control-label"><g:message code="lab.password.label" default="Password" /> <span class="required">*</span></label>
			    <div class="controls">
			         <g:passwordField name="password" class="span4" required="" value="${labInstance?.password}" autocomplete="false" />
