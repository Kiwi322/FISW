...
<html>
	...
	<body>
		<div class="page container">
			...
			<g:form url="[resource:bookInstance, action:'upload']"  enctype="multipart/form-data" class="form-horizontal">
				<div class="container">
					<div class="alert alert-block alert-info">
	                    <p>
	                       Ingresa la información del nuevo libro. Los campos marcados con asterisco son obligatorios.	
	                    </p>
	                </div>
