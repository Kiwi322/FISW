		...
		<div id="list-collaborator" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="collaborator.user.label" default="User" /></th>
					
						<th><g:message code="collaborator.proj.label" default="Proj" /></th>
				...
				<g:each in="${collaboratorInstanceList}" status="i" var="collaboratorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${collaboratorInstance.id}">${fieldValue(bean: collaboratorInstance, field: "user")}</g:link></td>
					
						<td>${fieldValue(bean: collaboratorInstance, field: "proj")}</td>
