...
<html>
	...
	<body>
		<div class="page container">
			...
			<g:form url="[resource:conferenceInstance, action:'upload']"  enctype="multipart/form-data" class="form-horizontal">
				<div class="container">
					<div class="alert alert-block alert-info">
	                    <p>
	                       Ingresa la información de la nueva conferencia. Los campos marcados con asterisco son obligatorios.	
	                    </p>
	                </div>
